...
: around body -> {
  ...
  <div class="container">
    <div class="form-horizontal well">
      <fieldset>
        <a href="/static/images/$json->{addfile}" class="btn btn-primary btn-lg btn-block" download="$json->{addfile}">ファイルをダウンロード<br></a>
      </fieldset>
    </div>
  </div>
